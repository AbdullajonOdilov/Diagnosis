...
from routes import login, users, uploaded_files, categories, questions, question_types, question_states, \
    question_options_answers, question_options, diagnostic_options, diagnostics, customers
...
app.include_router(question_options.question_options_router)
app.include_router(question_options_answers.question_options_answers_router)
